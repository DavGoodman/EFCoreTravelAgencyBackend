...
namespace EU_VIES
{
    ...
    [System.ServiceModel.ServiceContractAttribute(Namespace="urn:ec.europa.eu:taxud:vies:services:checkVat", ConfigurationName="EU_VIES.checkVatPortType")]
    public interface checkVatPortType
    {
        ...
        System.Threading.Tasks.Task<EU_VIES.checkVatResponse> checkVatAsync(EU_VIES.checkVatRequest request);
        
        // CODEGEN: Generating message contract since the operation has multiple return values.
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        [System.ServiceModel.XmlSerializerFormatAttribute(SupportFaults=true)]
        System.Threading.Tasks.Task<EU_VIES.checkVatApproxResponse> checkVatApproxAsync(EU_VIES.checkVatApproxRequest request);
    }
    ...
    public partial class checkVatApproxResponse
    {
        ...
        public checkVatApproxResponse(
                    ...
                    string traderCity, 
                    EU_VIES.matchCode traderNameMatch, 
                    EU_VIES.matchCode traderCompanyTypeMatch, 
                    EU_VIES.matchCode traderStreetMatch, 
                    EU_VIES.matchCode traderPostcodeMatch, 
                    EU_VIES.matchCode traderCityMatch, 
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public interface checkVatPortTypeChannel : EU_VIES.checkVatPortType, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.1.0")]
    public partial class checkVatPortTypeClient : System.ServiceModel.ClientBase<EU_VIES.checkVatPortType>, EU_VIES.checkVatPortType
    {
        ...
        public System.Threading.Tasks.Task<EU_VIES.checkVatResponse> checkVatAsync(EU_VIES.checkVatRequest request)
        {
            return base.Channel.checkVatAsync(request);
        }
        
        public System.Threading.Tasks.Task<EU_VIES.checkVatApproxResponse> checkVatApproxAsync(EU_VIES.checkVatApproxRequest request)
        {
